...
const testimonials = [
  {
    ...
    text: "Lamosa completely redefined our digital presence. Their strategic design approach and attention to user behavior boosted our conversion rate significantly.",
    author: "Sarah Coleman",
    role: "CMO",
    logoConfig: "G" // Placeholder for Google-like logo
  },
  {
    stat: "45%",
    label: "Reduced bounce rate",
    text: "The team at Lamosa not only built us a beautiful platform—they made it fast, smart, and incredibly intuitive. Their UI insights and performance tweaks made a huge difference.",
    author: "Marcus Levine",
    role: "Co-founder",
    logoConfig: "S" // Placeholder
  },
  {
    stat: "3x",
    label: "faster MVP launch",
    text: "Working with Lamosa helped us cut our launch timeline dramatically. They understand product goals and build with both speed and precision.",
    author: "Amina Khatri",
    role: "Head of Product",
    logoConfig: "L" // Placeholder
  },
  // The 4th item is the CTA card, handled separately in layout
];
    ...
    <section className="w-full bg-muted/30 dark:bg-background px-4 md:px-8 ">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-card rounded-[32px] grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
           ...
           >
              ...
              <div className="relative z-10">
                 ...
                 <button className="flex items-center gap-2 px-6 py-3 bg-primary-foreground text-primary dark:bg-primary dark:text-primary-foreground rounded-full font-medium hover:bg-primary-foreground/90 transition-colors self-start">
                    Book A Call
        ...
        <div className="flex justify-end items-center gap-2 mt-4 opacity-100">
             ...
             <span className="text-xs font-medium text-muted-foreground">From 150+ reviews</span>
        </div>
