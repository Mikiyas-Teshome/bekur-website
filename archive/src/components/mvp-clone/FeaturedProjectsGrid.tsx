...
const projects = [
  ...
  {
    title: "Mental Bank",
    tags: ["Fintech", "UX Design", "Mobile App"],
  ...
  },
  {
    ...
    tags: ["Delivery", "UX Design", "Mobile App"],
    ...
    <section className="w-full bg-muted/30 dark:bg-background px-4 md:px-8 py-[85px]">
       <div className="max-w-7xl mx-auto">
           <div className="flex flex-col justify-center items-center mb-12 gap-6 w-full">
              ...
              >
                 <p className="text-lg text-muted-foreground font-medium mb-2">Projects</p>
                 <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight">
                    <span>Here&apos;s what</span><br/>
                    <span className="text-muted-foreground">the momentum looks like.</span>
                 </h2>
              </motion.div>
           </div>
