  ...
  return (
    <section className="w-full bg-muted/30 dark:bg-background px-4 md:px-8 py-[85px]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
           <div>
              <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-2">62%</h3>
              <p className="text-lg text-muted-foreground mb-8">increase in mobile traffic retention</p>
           ...
           <div className="flex items-center gap-4">
              ...
              <div>
                  <div className="font-bold text-foreground">Julian Ortega</div>
        ...
        >
             ...
             <div className="relative z-10 max-w-md">
                ...
                <button className="group flex items-center gap-2 px-8 py-4 bg-primary-foreground text-primary rounded-full font-bold transition-transform hover:scale-105 active:scale-95">
                   Book A Call
